...
```HTML
<script src="https://unpkg.com/ol-pdf-printer@1.0.12"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/ol-pdf-printer@1.0.12/dist/css/ol-pdf-printer.css" />
<link rel="stylesheet" href="https://unpkg.com/ol-pdf-printer@1.0.12/dist/css/bootstrap.min.css" /> <!-- Bootstrap bundle -->
```
