...
-   [Basic usage](https://raw.githack.com/GastonZalba/ol-pdf-printer/v2.1.0/examples/basic.html)
...
```HTML
<script src="https://unpkg.com/ol-pdf-printer@2.1.0"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/ol-pdf-printer@2.1.0/dist/css/ol-pdf-printer.css" />
<link rel="stylesheet" href="https://unpkg.com/ol-pdf-printer@2.1.0/dist/css/bootstrap.min.css" /> <!-- Bootstrap bundle -->
```
