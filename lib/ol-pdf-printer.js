...
class ElementsPDF {
  constructor() {
    ...
    this.addElementsToPDF = (view, pdf, form, scaleDenominator, options) => __awaiter$1(this, void 0, void 0, function* () {
      this._view = view;
      this._pdf = pdf;
      this._form = form;
    ...
    this.addTextWithBack = (str, position, offset, fontSize, txcolor, bkcolor, brcolor, maxWidth, align) => {
      var paddingBack = 4;
      var {
        x,
        y
      ...
      this.addRoundedBox(x, y, w + paddingBack * 2, h + paddingBack, bkcolor, brcolor);
    ...
    this.addScale = (position, width, offset, fontSize, txcolor, align) => {
      ...
      var str = "Escala 1:".concat(this._scaleDenominator.toLocaleString('de'), " - Hoja ").concat(this._form.format.toUpperCase());
      this.addTextByOffset(position, offset, width, fontSize, txcolor, align, str);
    };
...
class PdfPrinter extends Control {
    ...
    this._options = {
      ...
      modal: {
        ...
        templates: {
          ...
          headerClose: "\n                    <button type=\"button\" class=\"btn-close\" data-dismiss=\"modal\" aria-label=\"".concat(this._i18n.close, "\">\n                        <span aria-hidden=\"true\">\xD7</span>\n                    </button>\n                    ")
        }
      }
    }; // Merge options
  ...
  printMap(form) {
    ...
    var [width, height] = mapSizeForPrint;
    ...
    this._map.once('rendercomplete', function () {
      domtoimage.toJpeg(this._mapTarget.querySelector('.ol-unselectable.ol-layers'), {
        ...
        yield addElementsToPDF(this._view, this._pdf, this._form, scaleDenominator, this._options);
        ...
        console.error(err);
        this.onEndPrint();
        showProcessingModal(this._118n.error,
        /** footer */
        true);
      });
