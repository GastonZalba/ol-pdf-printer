...
class ElementsPDF {
  constructor() {
    ...
    this.addScaleBar = (position, offset) => {
      ...
      var maxWidth = 100 + this._style.margin * 2; // in mm
  ...
  _printMap(form) {
    ...
    this._map.once('rendercomplete', () => {
      domtoimage.toJpeg(this._mapTarget.querySelector('.ol-unselectable.ol-layers'), {
        ...
        var scaleDenominator = this._calculateScaleDenominator(this._form.resolution, scaleResolution);
        ...
        this._processingModal.show(this._i18n.error,
        /** footer */
        true);
      });
    }); // Set print size
