/*!
 * ol-pdf-printer - v2.0.0
 * https://github.com/GastonZalba/ol-pdf-printer#readme
 * Built: Sat Oct 07 2023 15:14:44 GMT-0300 (Argentina Standard Time)
*/
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('ol/control/Control.js'), require('ol/proj.js'), require('ol/Observable.js'), require('ol/source/Cluster.js'), require('ol/layer/Vector.js'), require('jspdf'), require('pdfjs-dist'), require('ol/uri.js'), require('ol/proj/Units.js'), require('ol/source/ImageWMS.js'), require('ol/layer/Tile.js'), require('ol/layer/Image.js'), require('ol/source/TileWMS.js')) :
	typeof define === 'function' && define.amd ? define(['ol/control/Control.js', 'ol/proj.js', 'ol/Observable.js', 'ol/source/Cluster.js', 'ol/layer/Vector.js', 'jspdf', 'pdfjs-dist', 'ol/uri.js', 'ol/proj/Units.js', 'ol/source/ImageWMS.js', 'ol/layer/Tile.js', 'ol/layer/Image.js', 'ol/source/TileWMS.js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.PdfPrinter = factory(global.ol.control.Control, global.ol.proj, global.ol.Observable, global.ol.source.Cluster, global.ol.layer.Vector, global.jsPDF, global.pdfjsLib, global.ol.uri, global.ol.proj.Units, global.ol.source.ImageWMS, global.ol.layer.Tile, global.ol.layer.Image, global.ol.source.TileWMS));
})(this, (function (Control, proj_js, Observable_js, Cluster, VectorLayer, jspdf, pdfjsDist, uri_js, Units_js, ImageWMS, TileLayer, ImageLayer, TileWMS) { 'use strict';
	...
	class SettingsModal {
	    ...
	    Content(i18n, options) {
	        const { scales, dpi, mapElements, extraInfo, description, paperSizes } = options;
	        return (createElement("form", { id: "printMap" },
	            createElement("section", null,
	                ...
	                createElement("div", null,
	                    ...
	                    description && (createElement("div", null,
	...
	class PdfPrinter extends Control {
	     ...
	     * @protected
	     */
	    _getMapSizForPrint(width, height, resolution) {
	        const pixelsPerMapMillimeter = resolution / 25.4;
	        return [
	    ...
	    _printMap(form, showLoading = true, delay = 0) {
	        ...
	        setTimeout(() => {
	            ...
	            const mapSizeForPrint = this._getMapSizForPrint(widthPaper, heightPaper, form.resolution);
	    ...
	    createPdf(options, showLoading) {
	        ...
	        this._printMap(Object.assign({ format: (this._options.paperSizes.find((p) => p.selected) ||
	                ...
	                this._options.dpi[0]).value, orientation: 'landscape', compass: true, attributions: true, scalebar: true, legends: true, scale: 1000, typeExport: 'pdf' }, options), showLoading);
	    }
	}
	/**
	 * **_[enum]_**
